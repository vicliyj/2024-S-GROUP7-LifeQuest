extends Node2D
var enemyHealthStat = 100 # Temporary health value. Pull value from where enemy character statistics are stored.
var enemyAttackStat = 1 # Temporary attack value. Pull value from where enemy character statistics are stored.
